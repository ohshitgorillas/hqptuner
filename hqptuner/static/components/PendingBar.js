...
import { pendingPreset, connected, config } from "../store/signals.js";
...
export function PendingBar() {
  ...
  // The control connection, not `ready`: a configuration lane that is down leaves
  // every live setting writable, and the buttons stay live for them.
  const reach = connected.value;
