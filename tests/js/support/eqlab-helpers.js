...
import { curveOf } from "../../../scripts/eqlab/curve.js";
 ...
 *
 * @param {unknown[]} rows
 * @returns {{ calls: number, path: string | null, method: string | null }}
 */
export function serveRows(rows) {
  /** @type {{ calls: number, path: string | null, method: string | null }} */
