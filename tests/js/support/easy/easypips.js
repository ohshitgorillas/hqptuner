...
// the same reason tests/js/support/easy/easymark.js is: it reaches a tile through
// tests/js/support/easy/easytiles.js's `tileHtml`, and `store/easy/easyview.js` reads
...
// and the pips. The `apod-mark` class tests/js/support/easy/easymark.js reads is a
