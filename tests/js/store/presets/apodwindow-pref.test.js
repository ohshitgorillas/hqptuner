...
//
// Own process on purpose, and one case only (tests/js/store/narrow/plainnames-pref.test.js
...
// sees. The setter cases live in tests/js/store/presets/apodwindow-set.test.js and the
