...
//
// Run: node --import ./tests/js/support/vendor-resolve.js --test tests/js/store/presets/modulator-favorites.test.js

import test from "node:test";
import assert from "node:assert/strict";

import { favoritesWire, puts, modulatorPuts, settle } from "../../support/wire/favoriteswire.js";
import {
  favoriteFilters,
  favoriteModulators,
  favoritesError,
