...
//
// Own process on purpose (tests/js/store/presets/apodwindow-pref.test.js pins the
...
//
// Run: node --import ./tests/js/support/vendor-resolve.js --test tests/js/store/presets/apodwindow-pref-unset.test.js
