...
// facet starts at belongs to tests/js/store/narrow/narrowing-mode.test.js. Phase and
...
// tests/js/store/narrow/narrowing-lossy.test.js's subject.
//
// Run: node --import ./tests/js/support/vendor-resolve.js --test tests/js/store/narrow/narrowing.test.js
...
// (tests/js/store/narrow/phase-facet.test.js); `gauss-plain` carries none, and is what
...
// ratio pick are pinned in tests/js/store/narrow/narrowing-rate.test.js.
...
// tests/js/store/narrow/narrowing-lossy.test.js.
