...
// at "both" — and those controls are tests/js/store/narrow/narrowing-lossy.test.js's
// subject.
//
// Run: node --import ./tests/js/support/vendor-resolve.js --test tests/js/store/narrow/narrowing-mode.test.js
