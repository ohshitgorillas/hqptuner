...
//     `optionsFor("config", <form field>)` (store/ui/options.js), which is also the
...
//
// Run: node --import ./tests/js/support/vendor-resolve.js --test tests/js/store/guards/sdm-hide-superseded.test.js

import test from "node:test";
import assert from "node:assert/strict";

import { narrowOptions, narrowCount } from "../../../../hqptuner/static/store/narrow/match.js";
import { optionsFor } from "../../../../hqptuner/static/store/ui/options.js";
