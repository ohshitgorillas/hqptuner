// Behavioral suite for the LIVE cards' persisted disclosure in store/ui/prefs.js —
...
//
// Run: node --import ./tests/js/support/vendor-resolve.js --test tests/js/store/live/livecollapse-prefs.test.js
