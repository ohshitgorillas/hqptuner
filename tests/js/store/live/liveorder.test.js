...
// store/ui/prefs.js's `liveOrder` / `setLiveOrder` / `commitLiveOrder` as
...
//
// Run: node --import ./tests/js/support/vendor-resolve.js --test tests/js/store/live/liveorder.test.js
...
const PREFS_MODULE = "../../../../hqptuner/static/store/ui/prefs.js";
