...
- **The Conversion tab is gone; its cards moved to the Output tab.** Output now runs Backend / Mode / Rate, Pre-process, filter narrowing, the PCM and SDM chains, Filter length, DAC correction, then the two backend cards; every setting and its disclosure cues are unchanged.
