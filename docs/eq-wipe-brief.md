...
- `installStructural` (`components/xfeed/Card.js:89-93`): dismantles a compensation block only when `xfeedBlock` recognizes it; otherwise the raw rows reach `stageStructural`.
