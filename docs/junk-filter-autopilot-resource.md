...
The working 20k rule is therefore: block kept at or above -125 dB per Hz above the fold, loud-frame step over its cut, and either the ratio to the music under -15 dB or the step at or over the 14 dB yield; filter engages on the second consecutive such block and drops on the first block that fails. Celestial Blues, 10 kept blocks, reads real on every statistic.
