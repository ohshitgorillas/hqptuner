...
- `unmeasurable N: <reason>` where the line's input cannot be supplied through any public entry point in the checkout, or where the only way to get a value is against something live. Do not approximate.
