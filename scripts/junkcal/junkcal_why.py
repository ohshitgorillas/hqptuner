...
``scripts/junkcal/junkcal_seq.py`` says how many ticks disagree with their album label and how many writes
...
row here produces a record and no tick carries a 20k verdict. The cliff column below is the
reference-band fall, the rule this corpus is graded on.
