...
A class name is a string on one side and a selector on the other. Markup whose
class no stylesheet defines passes every other gate, renders, and silently
gets no styling.
...
def main() -> int:
    ...
    styled = css_classes(sorted((STATIC / "css").rglob("*.css")))
