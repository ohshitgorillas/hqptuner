...
Such a copy ships unflagged, which is the whole cost the one-component rule
exists to avoid (docs/design-system.md). A second copy of the frame is a second place to fix
